...
/*
    Log the hunter's name and the room they are moving to.
    in: hunter - the hunter name to log
...
/*
    Logs the hunter exiting the house and one of the reason of exit.
    in: hunter - the hunter name to log
...
/*
    Logs the hunter reviewing evidence, 
        stated either they had sufficient evidence to exit the simulation or not. 
    in: hunter - the hunter name to log
...
/*
    Log the hunter's name, the evidence they collected, 
        and the name of the room they collected it in.
    in: hunter - the hunter name to log
